...
<GuideProgress ns="howto-review-publish" total={6} />

<Checklist ns="howto-review-publish" title="Review & Publish Checkliste">
  <CheckItem id="owner">Owner im Drawer setzen</CheckItem>
  <CheckItem id="reviewers">Reviewer zuweisen</CheckItem>
  <CheckItem id="submit">„Zur Prüfung" senden</CheckItem>
  <CheckItem id="review">Review durchführen (Freigeben/Ablehnen)</CheckItem>
  <CheckItem id="publish">Veröffentlichen (Status → Published)</CheckItem>
  <CheckItem id="verify">Veröffentlichungsdatum prüfen</CheckItem>
</Checklist>
