      ...
      >
        ...
        >
          ...
          <div className="flex flex-wrap gap-4 justify-center">
            <Link href="/en" className="text-teal-600 hover:text-teal-700 underline">
              Home
            </Link>
            <Link href="/en/about" className="text-teal-600 hover:text-teal-700 underline">
              About Us
            </Link>
            <Link href="/en/career" className="text-teal-600 hover:text-teal-700 underline">
              Career
            </Link>
          </div>
        </motion.div>
