...
export default function VideoGenerationPage() {
  ...
  const navigationItems = [
    ...
    { id: 'ai-test', label: 'AI Test', href: '/en/ai-test' },
    { id: 'video-gen', label: 'Video Gen', href: '/en/video-generation' },
  ];
      ...
      <div className="max-w-6xl mx-auto px-6 py-24">
        ...
        >
          ...
          <p className="text-xl text-gray-300 max-w-4xl mx-auto leading-relaxed mb-8">
            Generate stunning videos with AI. Describe your vision and let Sora bring it to life.
          </p>
        </motion.div>
          ...
          <form onSubmit={handleSubmit} className="space-y-8">
            ...
            <div>
              <label className="block text-white font-semibold mb-4 text-lg">
                Describe your video prompt:
              </label>
              <textarea
                value={prompt}
                onChange={(e) => setPrompt(e.target.value)}
                placeholder="e.g. A sunrise over mountains, time-lapse with gentle clouds..."
          ...
          {result && (
            ...
            >
              <div className="flex items-center justify-between mb-6">
                <h3 className="text-green-400 font-semibold text-xl">Video generated successfully!</h3>
                <motion.button
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                ...
                <div className="space-y-4">
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    ...
                    <div>
                      <h4 className="text-white font-semibold mb-1">Quality:</h4>
                      <p className="text-gray-300">{result.quality}</p>
                    </div>
                  </div>

                  <div>
                    <h4 className="text-white font-semibold mb-1">Model:</h4>
        ...
        >
          <p className="text-sm">
            Powered by Sora AI • Comet API • Generate videos with AI technology
          </p>
        </motion.div>
      </div>
    </div>
