  ...
  const services = [
    {
      ...
      description: 'Modern ERP solutions with S/4HANA for optimized business processes and better performance.',
      features: ['Greenfield Implementation', 'Brownfield Migration', 'System Conversion', 'Data Migration']
    },
    {
      icon: Zap,
      title: 'SAP BTP & Integration',
      description: 'Business Technology Platform for seamless integration and extension of your SAP landscape.',
      features: ['API Management', 'Integration Suite', 'Extension Suite', 'Analytics Cloud']
    },
    {
      icon: Cog,
      title: 'ABAP/Fiori Development',
      description: 'Modern user experience with Fiori and customized ABAP solutions for your requirements.',
      features: ['Fiori Apps Development', 'ABAP OO Programming', 'Custom Reports', 'Workflow Solutions']
    },
    {
      icon: Shield,
      title: 'GxP/CSV & Compliance',
      description: 'Regulatory compliance for regulated industries with validated SAP systems.',
              ...
              <div className="text-center mb-16">
                ...
                <TextReveal delay={1.1}>
                  <p className="text-2xl text-white/90 max-w-4xl mx-auto leading-relaxed mb-16">
                    Transform your business with modern SAP solutions.
                    From S/4HANA to innovative BTP integrations.
                  </p>
                </TextReveal>
              ...
              <div className="text-center mb-24">
                ...
                <TextReveal delay={0.8}>
                  <p className="text-2xl text-white/80 max-w-3xl mx-auto">
                    Professional SAP solutions for modern enterprises
                  </p>
                </TextReveal>
              </div>
            </SlideIn>
              ...
              <div className="p-16 rounded-3xl bg-white/10 backdrop-blur-lg border border-white/20">
                ...
                <TextReveal delay={0.8}>
                  <p className="text-2xl text-white/90 mb-16 max-w-3xl mx-auto">
                    Let&apos;s develop and implement your SAP strategy together.
                  </p>
                </TextReveal>
