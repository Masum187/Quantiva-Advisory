  ...
  const services = [
    {
      ...
      description: 'Strategic cloud architecture for AWS, Azure and GCP with optimal cost-benefit ratio.',
      features: ['Cloud Assessment', 'Migration Planning', 'Cost Optimization', 'Governance Framework']
    },
    {
      icon: Server,
      title: 'Cloud Migration',
      description: 'Secure and efficient migration of your workloads to the cloud with minimal downtime.',
      features: ['Lift & Shift', 'Replatforming', 'Refactoring', 'Data Migration']
    },
    {
      icon: Zap,
      title: 'Cloud Native Development',
      description: 'Modern application development with cloud-native technologies and microservices architectures.',
      features: ['Container Orchestration', 'Serverless Computing', 'DevOps Pipelines', 'Auto Scaling']
    },
    {
      icon: Shield,
      title: 'Cloud Security & Compliance',
      description: 'Comprehensive security concepts for cloud environments with compliance and governance.',
              ...
              <div className="text-center mb-16">
                ...
                <TextReveal delay={1.1}>
                  <p className="text-2xl text-white/90 max-w-4xl mx-auto leading-relaxed mb-16">
                    Scale your business with modern cloud solutions.
                    From multi-cloud strategies to cloud-native development.
                  </p>
                </TextReveal>
              ...
              <div className="p-16 rounded-3xl bg-white/10 backdrop-blur-lg border border-white/20">
                ...
                <TextReveal delay={0.8}>
                  <p className="text-2xl text-white/90 mb-16 max-w-3xl mx-auto">
                    Let&apos;s develop and implement your cloud strategy together.
                  </p>
                </TextReveal>
