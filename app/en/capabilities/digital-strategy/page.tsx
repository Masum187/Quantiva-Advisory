  ...
  const services = [
    {
      ...
      description: 'Development of a customized digital strategy that connects your business goals with technological possibilities.',
      features: ['Business Case Analysis', 'Technology Roadmap', 'Digital Maturity Assessment', 'Strategic Planning']
    },
    {
      icon: Users,
      title: 'Change Management',
      description: 'Accompanying your organization through digital transformation with structured change management and training.',
      features: ['Stakeholder Management', 'Communication Strategy', 'Training Programs', 'Adoption Support']
    },
    {
      icon: TrendingUp,
      title: 'Process Optimization',
      description: 'Analysis and optimization of your business processes for maximum efficiency and digital integration.',
      features: ['Process Mapping', 'Gap Analysis', 'Automation Opportunities', 'Performance Metrics']
    },
    {
      icon: Lightbulb,
      title: 'Innovation Consulting',
      description: 'Identification and implementation of innovative technologies for sustainable competitive advantage.',
              ...
              <div className="text-center mb-16">
                ...
                <TextReveal delay={1.1}>
                  <p className="text-2xl text-white/90 max-w-4xl mx-auto leading-relaxed mb-16">
                    Shape your digital future with strategic consulting and sustainable solutions.
              ...
              <div className="text-center mb-24">
                ...
                <TextReveal delay={0.8}>
                  <p className="text-2xl text-white/80 max-w-3xl mx-auto">
                    Professional strategy consulting for digital transformation
                  </p>
                </TextReveal>
              </div>
            </SlideIn>
              ...
              <div className="p-16 rounded-3xl bg-white/10 backdrop-blur-lg border border-white/20">
                ...
                <TextReveal delay={0.8}>
                  <p className="text-2xl text-white/90 mb-16 max-w-3xl mx-auto">
                    Let&apos;s develop and successfully implement your digital strategy together.
                  </p>
                </TextReveal>
