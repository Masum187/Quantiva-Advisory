  ...
  const services = [
    {
      ...
      description: 'Identification and evaluation of AI use cases in your organization for maximum value creation.',
      features: ['Business Case Analysis', 'ROI Assessment', 'Feasibility Studies', 'Proof of Concepts']
    },
    {
      icon: Cpu,
      title: 'Model Training & Eval',
      description: 'Development, training and evaluation of machine learning models for your specific use cases.',
      features: ['Data Preparation', 'Model Selection', 'Training Pipelines', 'Performance Evaluation']
    },
    {
      icon: Zap,
      title: 'MLOps & GenAI',
      description: 'Implementation of MLOps practices and integration of Generative AI into your business processes.',
      features: ['Model Deployment', 'CI/CD Pipelines', 'LLM Integration', 'Prompt Engineering']
    },
    {
      icon: Shield,
      title: 'Guardrails & Compliance',
      description: 'Ensuring ethics, transparency and compliance in your AI solutions.',
          ...
          <SlideIn>
            <div className="text-center mb-16">
              ...
              <div className="inline-flex items-center gap-3 px-6 py-3 rounded-full bg-gradient-to-r from-purple-500/20 to-pink-500/20 border border-purple-500/30 mb-8">
                ...
                <span className="text-purple-300 text-sm font-semibold tracking-wider">ARTIFICIAL INTELLIGENCE (AI)</span>
              </div>
              ...
              <p className="text-xl text-gray-300 max-w-4xl mx-auto leading-relaxed">
                ...
                From use case discovery to ethical AI frameworks.
              </p>
            </div>
          </SlideIn>
        </div>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <SlideIn>
            ...
            <p className="text-xl text-purple-100 mb-12 max-w-2xl mx-auto">
              Let&apos;s develop and implement your AI strategy together.
            </p>
