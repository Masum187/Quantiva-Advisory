  ...
  const offerings = [
    {
      ...
      description: 'Strategische Beratung für Ihre SAP S/4HANA Transformation',
      features: ['Greenfield vs. Brownfield Analyse', 'ROI-Berechnung', 'Migrationsstrategie', 'Change Management']
    },
    {
      icon: Zap,
      title: 'SAP BTP Integration',
      description: 'Integration der SAP Business Technology Platform in Ihre Landschaft',
      features: ['API Management', 'Integration Suite', 'Extension Suite', 'Analytics Cloud']
    },
    {
      icon: Users,
      title: 'SAP Fiori & UX',
      description: 'Moderne Benutzeroberflächen und User Experience Design',
      features: ['Fiori App Development', 'UX/UI Design', 'Mobile Apps', 'Role-based Dashboards']
    },
    {
      icon: Target,
      title: 'SAP Testing & Quality',
      description: 'Umfassende Teststrategien und Qualitätssicherung',
          ...
          <SlideIn>
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-gray-300 max-w-4xl mx-auto leading-relaxed">
                Expertise in S/4HANA, BTP, Fiori und SAP-Integration. 
                Von der Strategie bis zur Implementierung begleiten wir Sie durch Ihre SAP-Transformation.
              </p>
            </div>
          </SlideIn>
        </div>
