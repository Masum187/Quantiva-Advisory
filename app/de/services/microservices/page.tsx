  ...
  const offerings = [
    {
      ...
      description: 'Design und Implementierung von Microservices-Architekturen',
    ...
    },
    {
      ...
      description: 'Containerisierung und Orchestrierung von Services',
      features: ['Docker Containerization', 'Kubernetes Orchestration', 'Service Mesh', 'Auto Scaling']
    },
    {
      icon: Shield,
      title: 'Integration & Monitoring',
      description: 'Nahtlose Integration und umfassendes Monitoring',
