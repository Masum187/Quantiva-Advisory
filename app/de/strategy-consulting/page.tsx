...
export default function StrategyConsultingPage() {
  ...
  const valuePunchlines = [
    "Von Vision zu Wirkung.",
    "Denken in Outcomes.",
    "Tech trifft Business.",
    "Entscheiden. Umsetzen. Skalieren.",
    "Quantiva Advisory."
  ];

  const pillars = [
    { name: "Strategie", icon: Brain },
  ...
  const processSteps = [
    "Entdecken → Entwerfen → Validieren → Skalieren",
    "Insights → Roadmap → Delivery → Impact"
  ];

  const impactMetrics = [
    { label: "Time-to-Value", value: "↓", color: "text-green-400" },
    { label: "Risiko", value: "↓", color: "text-red-400" },
    { label: "ROI", value: "↑", color: "text-green-400" },
    { label: "Adoption", value: "↑", color: "text-blue-400" }
  ];

  const growthAreas = [
    { title: "Early Ownership", description: "Übernimm früh Verantwortung" },
    { title: "Mentoring & Zertifizierungen", description: "Lerne von den Besten" },
    { title: "Lab-Zeit & Innovation", description: "Experimentiere und entwickle" },
    { title: "Klarer Karrierepfad", description: "Consultant → Senior → Lead → Principal" }
  ];
              ...
              >
                ...
                <div className="relative max-w-5xl mx-auto">
                  ...
                  <div className="absolute inset-0 overflow-hidden rounded-3xl">
                    <motion.div
                      className="absolute w-32 h-32 bg-gradient-to-br from-teal-500/10 to-purple-500/10 rounded-full blur-2xl"
                      animate={{
                        x: [0, 40, 0],
                        y: [0, -30, 0],
                        scale: [1, 1.3, 1],
                  ...
                  {/* Main Card */}
                  <div className="relative rounded-3xl bg-gradient-to-br from-black/60 via-black/40 to-black/60 border border-white/10 backdrop-blur-xl group-hover:border-teal-400/50 transition-all duration-500 group-hover:shadow-2xl group-hover:shadow-teal-500/30 transform-gpu overflow-hidden">
                    ...
                    <div className="relative z-10 p-8 md:p-12">
                      ...
                      <div className="text-center mb-8">
                        <motion.div
                          className="inline-flex items-center gap-3 px-6 py-3 rounded-full bg-gradient-to-r from-teal-500/20 to-purple-500/20 border border-teal-500/30 mb-6 backdrop-blur-sm"
                        ...
                        >
                          Deine <span className="bg-gradient-to-r from-teal-400 to-purple-400 bg-clip-text text-transparent">Mission</span>
                        </motion.h2>
                      </div>
                      ...
                      >
                        <div className="bg-gradient-to-r from-black/40 via-black/20 to-black/40 rounded-2xl p-8 border border-white/5 backdrop-blur-sm">
                          <p className="text-lg md:text-xl text-gray-200 leading-relaxed text-center">
                            Bei Quantiva Advisory begleitest du Unternehmen end-to-end – von der Vision bis zur messbaren Umsetzung. Als Strategy Consultant entwickelst du Markt- und Technologie-Roadmaps, übersetzt Business-Ziele in tragfähige Zielbilder und steuerst Transformationsprogramme. Im IT Consulting realisierst du moderne Lösungen in Cloud, Data & AI und ERP – nah am Kunden, nah am Ergebnis.
                          </p>
                        </div>
                      </motion.div>
                      ...
                      >
                        <div className="w-24 h-1 bg-gradient-to-r from-teal-500 via-purple-500 to-pink-500 rounded-full"></div>
                      </motion.div>
                    </div>
          ...
          <div className="mb-24">
            <SlideIn direction="up">
              <div className="text-center mb-16">
                ...
                >
                  Deine <span className="bg-gradient-to-r from-teal-400 via-purple-400 to-pink-400 bg-clip-text text-transparent animate-gradient">Entwicklung</span>
                </motion.h2>
                <motion.p 
                  ...
                  transition={{ duration: 0.8, delay: 0.2 }}
                >
                  Ein strukturierter Weg vom Consultant zum Principal – mit Mentoring, Innovation und klaren Karrierepfaden
                </motion.p>
              </div>
            </SlideIn>
                          ...
                          <div className="space-y-4">
                            ...
                            >
                              <div className="w-full py-3 px-4 bg-gradient-to-r from-teal-500/20 to-purple-500/20 border border-teal-400/30 rounded-xl text-center">
                                <span className="text-teal-400 font-semibold text-sm">Mehr erfahren</span>
                              </div>
                            </motion.div>
                          </div>
                        </div>
              ...
              >
                <div className="inline-block p-8 rounded-3xl bg-gradient-to-r from-teal-500/10 via-purple-500/10 to-pink-500/10 border border-teal-400/20 backdrop-blur-xl">
                  <h3 className="text-2xl font-bold text-white mb-4">
                    Bereit für deine <span className="text-teal-400">Entwicklung?</span>
                  </h3>
                  <p className="text-gray-300 mb-6 max-w-2xl mx-auto">
                    Starte deine Karriere bei Quantiva Advisory und werde Teil eines Teams, das Innovation und Wachstum fördert.
                  </p>
          ...
          <div className="mb-24">
            <SlideIn direction="up">
              <h2 className="text-4xl md:text-5xl font-bold text-white mb-16 text-center">
                Unser <span className="bg-gradient-to-r from-teal-400 to-purple-400 bg-clip-text text-transparent">Tech Stack</span>
              </h2>
            </SlideIn>
                ...
                <div className="space-y-8">
                  <div>
                    ...
                    <motion.p 
                      ...
                      transition={{ duration: 0.8, delay: 0.2 }}
                    >
                      Erfolg basiert auf der richtigen Strategie. Gestalte mit deinem Wissen und deinem strategischen Denken den digitalen Wandel.
                    </motion.p>
                  </div>
                  ...
                  >
                    ...
                    <div className="p-6 rounded-2xl bg-gradient-to-br from-teal-500/10 via-purple-500/10 to-transparent border border-teal-400/20 backdrop-blur-xl">
                      ...
                      <p className="text-gray-200 leading-relaxed">
                        Steile Lernkurve, Mentoring durch Senior:innen, Zertifizierungen, Lab-Zeit für Innovationen und klare Karrierepfade (Consultant → Senior → Lead → Principal). Du übernimmst früh Verantwortung, präsentierst beim Kunden, setzt Standards – und prägst die Quantiva-Story aktiv mit.
                      </p>
                    </div>
                  </motion.div>
              ...
              >
                <div className="p-8 rounded-3xl bg-gradient-to-r from-teal-500/20 to-purple-500/20 border border-teal-400/30 backdrop-blur-xl">
                  ...
                  <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto">
                    Werde Teil von Quantiva Advisory und gestalte die digitale Zukunft mit.
                  </p>
