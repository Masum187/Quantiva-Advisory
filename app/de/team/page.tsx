    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-slate-100">
      ...
      <section className="relative min-h-[60vh] flex items-center justify-center overflow-hidden bg-gradient-to-br from-slate-900 via-teal-900 to-slate-800">
        ...
        <div className="relative z-10 max-w-5xl mx-auto px-6 text-center">
          ...
          >
            Mit über 15 Jahren Erfahrung in der Unternehmensberatung und einem starken Fokus auf digitale Transformation
            führt unser Team mit Innovation und strategischer Weitsicht.
          </motion.p>
        </div>
        ...
        <SlideIn>
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-gray-900 mb-4">
              Die Experten hinter Quantiva
            </h2>
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
              Ein Team von Visionären und Machern
            </p>
          </div>
        </SlideIn>
                ...
                <div className="p-8">
                  ...
                  <div className="mb-6">
                    ...
                    <div className="flex flex-wrap gap-2">
                      {member.expertiseDe.split(',').map((skill, i) => (
                        <span
                          key={i}
          ...
          <SlideIn>
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-slate-300 max-w-2xl mx-auto">
                Die Prinzipien, die uns antreiben
              </p>
            </div>
          </SlideIn>
