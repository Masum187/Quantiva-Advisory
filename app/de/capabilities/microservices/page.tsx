  ...
  const services = [
    {
      ...
      description: 'Entwicklung skalierbarer Microservices-Architekturen basierend auf Domain-Driven Design Prinzipien.',
      features: ['Bounded Contexts', 'Aggregate Design', 'Event Sourcing', 'CQRS Pattern']
    },
    {
      icon: Layers,
      title: 'API-Gateway & Governance',
      description: 'Zentrale API-Verwaltung und Governance für konsistente und sichere Service-Kommunikation.',
      features: ['API Gateway Setup', 'Rate Limiting', 'Authentication', 'API Documentation']
    },
    {
      icon: Zap,
      title: 'Event-/Async-Patterns',
      description: 'Implementierung asynchroner Kommunikationsmuster für hochperformante, entkoppelte Systeme.',
      features: ['Event Streaming', 'Message Queues', 'Pub/Sub Patterns', 'Saga Patterns']
    },
    {
      icon: Activity,
      title: 'Observability',
      description: 'Umfassendes Monitoring, Logging und Tracing für Microservices-Architekturen.',
          ...
          <SlideIn>
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-gray-300 max-w-4xl mx-auto leading-relaxed">
                Skalierbare und wartbare Systeme durch moderne Microservices-Architekturen. 
                Von Domain-Driven Design bis hin zu umfassender Observability.
              </p>
            </div>
          </SlideIn>
        </div>
          ...
          <SlideIn>
            <div className="text-center mb-20">
              ...
              <p className="text-xl text-gray-300 max-w-3xl mx-auto">
                Moderne Architekturen für skalierbare und wartbare Systeme
              </p>
            </div>
          </SlideIn>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <SlideIn>
            ...
            <p className="text-xl text-blue-100 mb-12 max-w-2xl mx-auto">
              Lassen Sie uns gemeinsam Ihre Microservices-Strategie entwickeln und implementieren.
            </p>
