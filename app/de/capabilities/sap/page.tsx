...
import { Database, Cog, Shield, Zap, ArrowLeft, CheckCircle } from 'lucide-react';
  ...
  const services = [
    {
      ...
      description: 'Moderne ERP-Lösungen mit S/4HANA für optimierte Geschäftsprozesse und bessere Performance.',
      features: ['Greenfield Implementation', 'Brownfield Migration', 'System Conversion', 'Data Migration']
    },
    {
      icon: Zap,
      title: 'SAP BTP & Integration',
      description: 'Business Technology Platform für nahtlose Integration und Erweiterung Ihrer SAP-Landschaft.',
      features: ['API Management', 'Integration Suite', 'Extension Suite', 'Analytics Cloud']
    },
    {
      icon: Cog,
      title: 'ABAP/Fiori Development',
      description: 'Moderne User Experience mit Fiori und maßgeschneiderte ABAP-Lösungen für Ihre Anforderungen.',
      features: ['Fiori Apps Development', 'ABAP OO Programming', 'Custom Reports', 'Workflow Solutions']
    },
    {
      icon: Shield,
      title: 'GxP/CSV & Compliance',
      description: 'Regulatorische Compliance für regulierte Branchen mit validierten SAP-Systemen.',
      features: ['Validation Planning', 'CSV Documentation', 'Risk Assessment', 'Change Control']
    }
  ];
            ...
            <SlideIn delay={0.2}>
              <div className="text-center mb-16">
                ...
                <TextReveal delay={0.5}>
                  <div className="inline-flex items-center gap-3 px-8 py-4 rounded-full bg-gradient-to-r from-blue-500/30 to-cyan-500/30 border border-blue-400/50 mb-12 backdrop-blur-sm">
                    <Database className="w-8 h-8 text-blue-300" />
                    <span className="text-white text-lg font-semibold tracking-wider">SAP SERVICES</span>
                  </div>
                </TextReveal>
                ...
                <TextReveal delay={1.1}>
                  <p className="text-2xl text-white/90 max-w-4xl mx-auto leading-relaxed mb-16">
                    Transformieren Sie Ihr Unternehmen mit modernen SAP-Lösungen.
                    Von S/4HANA bis hin zu innovativen BTP-Integrationen.
                  </p>
                </TextReveal>
                ...
                <TextReveal delay={1.4}>
                  <div className="flex flex-col sm:flex-row gap-6 justify-center">
                    <Link
                      href="/de#contact"
                      className="px-12 py-6 bg-gradient-to-r from-blue-600 to-cyan-600 text-white text-xl font-semibold rounded-2xl hover:from-blue-700 hover:to-cyan-700 transition-all duration-300 shadow-2xl hover:scale-105 backdrop-blur-sm"
                    >
              ...
              <div className="text-center mb-24">
                ...
                <TextReveal delay={0.8}>
                  <p className="text-2xl text-white/80 max-w-3xl mx-auto">
                    Professionelle SAP-Lösungen für moderne Unternehmen
                  </p>
                </TextReveal>
              </div>
            </SlideIn>
                  ...
                  <SlideIn key={index} delay={index * 0.2 + 0.5}>
                    ...
                    >
                      <div className="flex items-center gap-6 mb-8">
                        <div className="w-20 h-20 rounded-2xl bg-gradient-to-br from-blue-500/30 to-cyan-500/30 border border-blue-300/50 flex items-center justify-center backdrop-blur-sm group-hover:scale-110 transition-transform duration-300">
              ...
              <div className="p-16 rounded-3xl bg-white/10 backdrop-blur-lg border border-white/20">
                ...
                <TextReveal delay={0.8}>
                  <p className="text-2xl text-white/90 mb-16 max-w-3xl mx-auto">
                    Lassen Sie uns gemeinsam Ihre SAP-Strategie entwickeln und umsetzen.
                  </p>
                </TextReveal>
                ...
                <TextReveal delay={1.1}>
                  <div className="flex flex-col sm:flex-row gap-8 justify-center">
                    <Link
                      href="/de#contact"
                      className="px-16 py-8 bg-gradient-to-r from-blue-600 to-cyan-600 text-white text-2xl font-semibold rounded-2xl hover:from-blue-700 hover:to-cyan-700 transition-all duration-300 shadow-2xl hover:scale-105 backdrop-blur-sm"
                    >
                      SAP-Beratung anfragen
                    </Link>
                    <Link
