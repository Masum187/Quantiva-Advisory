...
export default function QuantivaWebsite() {
  ...
  return (
    <div className="min-h-screen text-white relative overflow-hidden">
      {/* Dark Purple/Indigo Gradient Background - Full Page */}
      <div className="fixed inset-0 z-0 pointer-events-none">
        ...
        {[
          ...
          { x: '80%', y: '75%', color: 'rgba(255, 255, 255, 0.3)', size: 5 },
          { x: '35%', y: '45%', color: 'rgba(255, 255, 255, 0.4)', size: 4 },
      ...
      <section className="relative z-10 bg-black/20 backdrop-blur-md py-24">
        <div className="mx-auto max-w-7xl px-6">
          {/* Upper Part: Cloud Migration Cards */}
          <motion.div
          ...
          {/* Lower Part: Key Metrics */}
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 pt-12 text-center md:text-left">
            {[
              { value: "60%", label: lang === 'de' ? "SCHNELLERE TIME-TO-VALUE" : "FASTER TIME-TO-VALUE" },
              { value: "30+", label: lang === 'de' ? "MITTELSTANDSREFERENZEN" : "MID-MARKET REFERENCES" },
              { value: "ISO 27001", label: lang === 'de' ? "SICHER & AUDIT-READY" : "SECURE & AUDIT-READY" }
